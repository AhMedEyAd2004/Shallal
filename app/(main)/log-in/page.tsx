      ...
      <div className="m-auto h-full w-full max-w-sm">
        ...
        <Card className="mt-6 p-8 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-150 ease-out fill-mode-both">
          <form action="" className="space-y-5">
            ...
            <Button className="w-full transition-all active:scale-98 will-change-transform">
              Sign In
            </Button>
          </form>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              type="button"
              variant="outline"
              className="transition-all active:scale-98 will-change-transform"
            >
              <svg
        ...
        <p className="text-muted-foreground mt-6 text-center text-sm animate-in fade-in duration-700 delay-300 ease-out fill-mode-both">
